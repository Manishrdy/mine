...
def prepInnings2(team1, team2, target):
    ...
    for i in range(1,101):
        ...
        count = count + 1
        print(batsman1+' : '+str(initialStrikerRuns))
    ...
    batsmenScoreboardTwo = pd.DataFrame(batsmenScoreboard2, columns =['Batsman','Dismissal Mode','Fielder','Bowler','Runs','Balls','4s','6s','SR'])
...
def prepInnings(team1, team2):
    ...
    print()
    batsmenScoreboardOne = pd.DataFrame(batsmenScoreboard1, columns =['Batsman','Dismissal Mode','Fielder','Bowler','Runs','Balls','4s','6s','SR'])
