...
for i in range(1,31):
    ...
    if ballOutcome == ['OUT']:
        if count % 10 == 0:
            ...
            # print(batsman1+' runs -> '+str(initialStrikerRuns)+' balls -> '+str(initialStrikerBallsCount))
            #When outcome == 0 run, strike changes
            ...
            initialStrikerBallsCount = initialStrikerBallsCount + 1
            # print(batsman1+' runs -> '+str(initialStrikerRuns)+' balls -> '+str(initialStrikerBallsCount))
            #When outcome == 0 run, no strike changes
    ...
    if ballOutcome == [1]:
        if count % 10 == 0: #when outcome 1 on last ball of over, strike change.
            ...
            initialStrikerBallsCount = initialStrikerBallsCount + 1
            # print(batsman1+' runs -> '+str(initialStrikerRuns)+' balls -> '+str(initialStrikerBallsCount))
            #When outcome == 1 run, no strike changes
            initialStrikerRuns, intialNonStrikerRuns = initialStrikerRuns, intialNonStrikerRuns
            initialStrikerBallsCount, initialNonStrikerBallsCount = initialStrikerBallsCount, initialNonStrikerBallsCount
        else:
            #add runs to strike batsmen
            initialStrikerRuns = initialStrikerRuns + 1
            initialStrikerBallsCount = initialStrikerBallsCount + 1
            # print(batsman2+' runs -> '+str(initialStrikerRuns)+' balls -> '+str(initialStrikerBallsCount))
            #When outcome == 1 run, strike changes
            initialStrikerRuns, intialNonStrikerRuns = intialNonStrikerRuns, initialStrikerRuns
            initialStrikerBallsCount, initialNonStrikerBallsCount = initialNonStrikerBallsCount, initialStrikerBallsCount
    elif ballOutcome == [2]:
        if count % 10 == 0:
            ...
            initialStrikerBallsCount = initialStrikerBallsCount + 1
            # print(batsman1+' runs -> '+str(initialStrikerRuns)+' balls -> '+str(initialStrikerBallsCount))
            #When outcome == 2 run, strike changes
            initialStrikerRuns, intialNonStrikerRuns = intialNonStrikerRuns, initialStrikerRuns
            initialStrikerBallsCount, initialNonStrikerBallsCount = initialNonStrikerBallsCount, initialStrikerBallsCount
        else:
            #add runs to strike batsmen
            ...
            initialStrikerBallsCount = initialStrikerBallsCount + 1
            # print(batsman1+' runs -> '+str(initialStrikerRuns)+' balls -> '+str(initialStrikerBallsCount))
            #When outcome == 2 run, no strike changes
            initialStrikerRuns, intialNonStrikerRuns = initialStrikerRuns, intialNonStrikerRuns
            initialStrikerBallsCount, initialNonStrikerBallsCount = initialStrikerBallsCount, initialNonStrikerBallsCount
    elif ballOutcome == [3]:
        if count % 10 == 0:
            ...
            initialStrikerBallsCount = initialStrikerBallsCount + 1
            # print(batsman1+' runs -> '+str(initialStrikerRuns)+' balls -> '+str(initialStrikerBallsCount))
            #When outcome == 3 run, no strike changes
            initialStrikerRuns, intialNonStrikerRuns = initialStrikerRuns, intialNonStrikerRuns
            initialStrikerBallsCount, initialNonStrikerBallsCount = initialStrikerBallsCount, initialNonStrikerBallsCount
        else:
            #add runs to strike batsmen
            ...
            initialStrikerBallsCount = initialStrikerBallsCount + 1
            # print(batsman2+' runs -> '+str(initialStrikerRuns)+' balls -> '+str(initialStrikerBallsCount))
            #When outcome == 3 run, strike changes
            initialStrikerRuns, intialNonStrikerRuns = intialNonStrikerRuns, initialStrikerRuns
            initialStrikerBallsCount, initialNonStrikerBallsCount = initialNonStrikerBallsCount, initialStrikerBallsCount
    elif ballOutcome == [4]:
        if count % 10 == 0:
            ...
            # print(batsman1+' runs -> '+str(initialStrikerRuns)+' balls -> '+str(initialStrikerBallsCount))
            #When outcome == 4 run, strike changes
            ...
            initialStrikeFour = initialStrikeFour + 1
            # print(batsman1+' runs -> '+str(initialStrikerRuns)+' balls -> '+str(initialStrikerBallsCount))
            #When outcome == 4 run, no strike changes
        ...
        if count % 10 == 0:
            ...
            initialStrikeSix = initialStrikeSix + 1
            # print(batsman1+' runs -> '+str(initialStrikerRuns)+' balls -> '+str(initialStrikerBallsCount))
            #When outcome == 6 run, no strike changes
    ...
    if count % 10 == 0:
        print('     {}     ({}){}'.format(batsman1,initialStrikerRuns,initialStrikerBallsCount))
        print('     {}     ({}){}'.format(batsman2,intialNonStrikerRuns,initialNonStrikerBallsCount))
        print('     {}     {}-{}-{}-{}'.format(bowlerPresent,'10',initialDotBalls,initialScore,initialOut))
        print()
